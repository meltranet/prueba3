<?php 
	...
	if (postExi('cMotivo')==true) {
		$lcPro = "CALL melClasificacionEli(1,".
		...
		$lcPro = "CALL melClasificacionEli(0,".
			idbPost('idMelClasificacion').",".
			cdbPost('cMotivo').idbMel();
		$laMel = dbResFilIni($lcPro);
	}
...
<body>
	...
	<h1>Eliminar la Clasificaci&oacute;n</h1>
    <div class="menuH">
		<ul class="menuH">
    ...
    <div style="padding-top:6px; width:280px;">
		<form method="post">
			...
			<div style="padding:6px;"><button type="submit">Eliminar clasificaci&oacute;n</button></div>
		</form>
	</div>
</body>
</html>
