	    ...
	    <div style="width:280px;">
        	<div style="padding-top:6px;">
				<div style="padding-top:6px; padding-left:6px;">
    	   			Introduzca un nombre para el nuevo permiso de acceso.
				</div>
			...
			<div style="padding:6px;"><button type="submit">Crear permiso</button></div>
		</div>
	</form>
</body>
</html>
