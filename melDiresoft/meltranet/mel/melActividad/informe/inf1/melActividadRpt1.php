<?php 
	...
	if (postExi('iImprimir')==true) {
		$lcPro = "CALL melActividadInfRec1(2,".
			idbPost('idCliente').",".
			cdbPost('cDesde').",".
	...
	$lcPro = "CALL melActividadInfRec1(3,".
		idbPost('idCliente').",".
		cdbPost('cDesde').",".
		cdbPost('cHasta').idbMel();
...
<body>
	...
	?>
    <h1>Informe de Actividades por Cliente</h1>
    ...
    <div style="margin-top:12px; padding-left:12px; margin-right:12px; width:740px;">
		<div class="listaFilaTitulo">
			...
			<div style="width:76px; text-align:left; font-size:11px;" class="listaCeldaTitulo1">Realizada</div>
			<div style="width:80px; text-align:left; font-size:11px;" class="listaCeldaTitulo1">Actividad</div>
			<div style="width:370px; text-align:left; font-size:11px;" class="listaCeldaTitulo1">Descripci&oacute;n</div>
			<div style="width:70px; text-align:center; font-size:11px;" class="listaCeldaTitulo1">Incidente</div>
			<div style="width:80px; text-align:center; font-size:11px;" class="listaCeldaTitulo2">Duracion</div>
		...
		function inf1 ($taInf) {?>
			<div>
				...
				<div style="width:76px; text-align:left;" class="listaCeldaNormal1"><?php dMostrar($taInf['dRealizadaFecha']);?></div>
				<div style="width:80px; text-align:left;" class="listaCeldaNormal1"><?php cMostrar($taInf['cNumero']);?></div>
				<div style="width:370px; text-align:left;" class="listaCeldaNormal1"><?php cMostrar($taInf['cDescripcion'],50);?></div>
				<div style="width:70px; text-align:center;" class="listaCeldaNormal1"><?php cMostrar($taInf['cMelIncidenteNumero']);?></div>
    				<div style="width:80px; text-align:center;" class="listaCeldaNormal2"><?php cMostrar($taInf["cDuracion"]);?></div>
	   	        <div class="listaCeldaCorte"></div>
			</div><?php
		}
		function inf2 ($taInf) {?>
			<div>
				...
				<div style="width:534px; text-align:left;" class="listaCeldaNormal1">Total&nbsp;<?php cMostrar($taInf['cClienteNombre']);?></div>
				<div style="width:70px; text-align:center;" class="listaCeldaNormal1">&nbsp;</div>
				<div style="width:80px; text-align:center; border-top:#000000 solid 1px;" class="listaCeldaNormal2"><?php cMostrar($taInf["cDuracion"]);?></div>
	   	        <div class="listaCeldaCorte"></div>
			</div><?php
		}
		function total($taInf) {?>
			...
			<div>
				<div style="width:20px; text-align:left;" class="listaCeldaNormal0"><?php iMostrar($taInf['iFila']);?></div>
				<div style="width:534px; text-align:left;" class="listaCeldaNormal1">TOTAL</div>
				<div style="width:70px; text-align:center;" class="listaCeldaNormal1">&nbsp;</div>
				<div style="width:80px; text-align:center; border-top:#000000 solid 1px;" class="listaCeldaNormal2"><?php cMostrar($taInf["cDuracion"]);?></div>
	   	        <div class="listaCeldaCorte"></div>
			</div><?php
