...
<body>
	...
	<div style="padding-top:6px; width:280px;">
		<form method="post">
    		<input name="idMelCierre" value="<?php cMostrar($laMel['idMelCierre']); ?>" type="hidden">
			...
			<div style="padding:6px;"><button type="submit">Anular cierre</button></div>
		</form>
	</div>
</body>
</html>
