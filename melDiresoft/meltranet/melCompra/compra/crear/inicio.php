<?php include '../../../meltranet.php';
	...
	if (postExi('idProveedor')==true) {
		$lcPro = "CALL compraIns(0,".
			idbPost('idProveedor').idbMel();
		$laMel = dbResFilIni($lcPro);
		if ($laMel["iError"] == 0) {cargarPag('factura/inicio.php');}
	}
	
	$laLis = lisIni('proveedorRec1');

	$lcPro = "CALL proveedorRec1(0,0,0,'',''".idbMel();
...
<body>
	...
	<div style="padding-top:6px;">
		<div style="width:370px; float:left; border-right:none;" class="lista">
			...
			$lcPro = "CALL proveedorRec1(".idbVal($laLis['iRec']).",".
		...
		<div style="width:364px; float:right;">
			Seleccione un proveedor para la compra.
		</div>
