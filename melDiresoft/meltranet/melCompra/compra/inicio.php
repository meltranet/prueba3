<?php include '../../meltranet.php';
	...
	$laLis = lisIni('compraRec');	
	
	$lcPro = "CALL compraRec(".idbVal(0).",".
		idbVal(0).",".
		idbVal(0).",".
		cdbVal('').",".
		cdbVal('').",".
...
<body>
    ...
    <div class="menuH">
		<ul class="menuH">
			<li class="menuH"><a class="menuH" href="crear" target="_self">crear una compra</a></li>
			<li class="menuH"><span class="separadorH">&#x2022;</span><li class="menuH"><a class="menuH" href="informe" target="_self">informes de compras</a></li>
		</ul>
    </div>
...
<?php
	...
	$lcPro = "CALL compraRec(".idbVal($laLis['iRec']).",".
	...
	while ($laMel = dbResFilCar($loReg)) {
		...
		<form method="post" action="ver/inicio.php">
        	<input type="hidden" name="idCompra" value="<?php iMostrar($laMel["idCompra"]);?>">
	    	<div class="<?php cMostrar($lcRegCla);?>">
            	<button type="submit" class="<?php cMostrar($lcBotCla);?>">
					...
					<div style="width:360px;" class="enviarFila"><?php cMostrar($laMel["cProveedorNombre"],40);?></div>
