<?php include '../../../../meltranet.php';
	...
	if (postExi('iImprimir')==true) {
		$lcPro = "CALL comprainfRec(1,".
			cdbPost('cDesde').",".
			cdbPost('cHasta').idbMel();
		$laMel = dbResFilIni($lcPro);
	} 
		
	$lcPro = "CALL comprainfRec(2,".
		cdbPost('cDesde').",".
		cdbPost('cHasta').idbMel();
...
<body>
    ...
    <div style="margin-top:12px; padding-left:12px; margin-right:12px; width:740px;">
		<div class="listaFilaTitulo">
			...
			<div style="width:70px; text-align:left; font-size:11px;" class="listaCeldaTitulo1">F. Emisi&oacute;n</div>
		...
		function inf0 ($taInf) {?>
			<div>
				...
				<div style="width:70px; text-align:left;" class="listaCeldaNormal1"><?php cMostrar($taInf['dFacturaFecha']);?></div>
