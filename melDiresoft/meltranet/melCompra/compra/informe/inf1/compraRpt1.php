<?php include '../../../../meltranet.php';
	...
	if (postExi('iImprimir')==true) {
		$lcPro = "CALL comprainfRec1(1,".
			cdbPost('cDesde').",".
			cdbPost('cHasta').idbMel();
		$laMel = dbResFilIni($lcPro);
	} 
		
	$lcPro = "CALL comprainfRec1(2,".
		cdbPost('cDesde').",".
		cdbPost('cHasta').idbMel();
...
<body>
    ...
    <div style="margin-top:12px; padding-left:12px; margin-right:12px; width:740px;">
		<div class="listaFilaTitulo">
			...
			<div style="width:70px; text-align:left; font-size:11px;" class="listaCeldaTitulo1">Compra</div>
			...
			<div style="width:70px; text-align:right; font-size:11px;" class="listaCeldaTitulo1">Total</div>
			<div style="width:70px; text-align:right; font-size:11px;" class="listaCeldaTitulo2">Saldo</div>
		...
		function inf0 ($taInf) {?>
			<div>
				...
				<div style="width:70px; text-align:right;" class="listaCeldaNormal1"><?php yMostrar($taInf['yTotal']);?></div>
    			<div style="width:70px; text-align:right;" class="listaCeldaNormal2"><?php yMostrar($taInf["ySaldo"]);?></div>
	   	        <div class="listaCeldaCorte"></div>
			</div><?php
		}
		function inf1 ($taInf) {?>
			...
			<div>
				...
				<div style="width:526px; text-align:left;" class="listaCeldaNormal1">TOTALES</div>
				<div style="width:70px; text-align:right;" class="listaCeldaNormal1"><?php yMostrar($taInf["yTotal"]);?></div>
				<div style="width:70px; text-align:right;" class="listaCeldaNormal2"><?php yMostrar($taInf["ySaldo"]);?></div>
	   	        <div class="listaCeldaCorte"></div>
			</div><?php
