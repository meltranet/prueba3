<?php include '../../../../meltranet.php';
	...
	$lcPro = "CALL comprainfRec1(0,'',''".idbMel();
...
<body>
    <div class="menuN">
		<ul class="menuN">
            ...
            <li class="menuN"><a class="menuN" href="../" target="_parent">Informes de Compras</a><span class="separadorN">/</span></li>
		</ul>
    </div>
	<h1>Informe de Compras por Pagar</h1>
	<form method="post" action="compraRpt1.php" target="_blank">
