...
<body>
	...
	<h1>Cambiar el Tel&eacute;fono</h1>
    <div class="menuH">
		<ul class="menuH">
	    ...
	    <div style="width:280px; padding-top:3px;">
			<div style="border-bottom:1px solid #C6D4E0; padding:6px;">
				<div style="padding-bottom:3px;">
    	   			Introduzca el nuevo Tel&eacute;fono.
				</div>
			    <div style="padding:3px; border:1px solid #C6D4E0;">
		            <input name="cTelefono" style="width:260px; font-family:Arial; font-size:13px; margin:0px; padding:0px; border:none; background:none;"
			        	value="<?php cMostrar($laMel['cTelefono']); ?>" maxlength="40">
				</div>
			</div>
			<div style="border-bottom:1px solid #C6D4E0; padding:6px;">
				<div style="padding-bottom:3px;">
			...
			<div style="padding:6px;"><button type="submit">Cambiar tel&eacute;fono</button></div>
		</div>
	</form>
</body>
</html>
