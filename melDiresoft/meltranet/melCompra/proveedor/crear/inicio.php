...
<body>
    <div class="menuN">
		<ul class="menuN">
			...
			<li class="menuN"><a class="menuN" href="../../../" target="_top">Compra</a><span class="separadorN">/</span></li>
	    ...
	    <div style="width:280px; padding-top:3px;">
			<div style="border-bottom:1px solid #C6D4E0; padding:6px;">
				<div style="padding-bottom:3px;">
    	   			Introduzca un nombre para el nuevo proveedor.
				</div>
			...
			<div style="padding:6px;"><button type="submit">Crear proveedor</button></div>
		</div>
	</form>
</body>
</html>
