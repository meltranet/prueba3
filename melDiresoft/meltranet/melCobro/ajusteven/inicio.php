<?php include '../../meltranet.php';
	...
	$laLis = lisIni('ajustevenRec');	
	
	$lcPro = "CALL ajustevenRec(".idbVal(0).",".
		idbVal(0).",".
		idbVal(0).",".
		cdbVal('').",".
		cdbVal('').",".
...
<body>
	...
	<h1>Ajustes en ventas</h1>
    <div class="menuH">
		<ul class="menuH">
			<li class="menuH"><a class="menuH" href="crear" target="_self">crear un ajuste</a></li>
		</ul>
    </div>
...
<?php
	...
	$lcPro = "CALL ajustevenRec(".idbVal($laLis['iRec']).",".
	...
	while ($laMel = dbResFilCar($loReg)) {
		...
		<form method="post" action="ver/inicio.php">
        	<input type="hidden" name="idAjusteven" value="<?php iMostrar($laMel["idAjusteven"]);?>">
