<?php include '../../meltranet.php';
	...
	$laLis = lisIni('cobroRec');	
	
	$lcPro = "CALL cobroRec(".idbVal(0).",".
		idbVal(0).",".
		idbVal(0).",".
		cdbVal('').",".
		cdbVal('').",".
...
<body>
    ...
    <div class="menuH">
		<ul class="menuH">
			<li class="menuH"><a class="menuH" href="crear" target="_self">crear un cobro</a></li>
		</ul>
    </div>
...
<?php
	...
	$lcPro = "CALL cobroRec(".idbVal($laLis['iRec']).",".
	...
	while ($laMel = dbResFilCar($loReg)) {
		...
		<form method="post" action="ver/inicio.php">
        	<input type="hidden" name="idCobro" value="<?php iMostrar($laMel["idCobro"]);?>">
