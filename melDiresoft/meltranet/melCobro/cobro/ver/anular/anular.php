...
<body>
	...
	<div style="padding-top:6px; width:280px;">
		<form method="post">
    		<input name="idCobro" value="<?php cMostrar($laMel['idCobro']); ?>" type="hidden">
			...
			<div style="padding:6px;"><button type="submit">Anular cobro</button></div>
		</form>
	</div>
</body>
</html>
