<?php include '../../meltranet.php';
	...
	$laLis = lisIni('clienteRec');	
	
	$lcPro = "CALL clienteRec(".idbVal(0).",".
		idbVal(0).",".
		idbVal(0).",".
		cdbVal('').",".
		cdbVal('').",".
...
<body>
    ...
    <div class="menuH">
		<ul class="menuH">
			<li class="menuH"><a class="menuH" href="crear" target="_self">crear un cliente</a></li>
		</ul>
    </div>
...
<?php
	...
	$lcPro = "CALL clienteRec(".idbVal($laLis['iRec']).",".
