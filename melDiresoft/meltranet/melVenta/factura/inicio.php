<?php include '../../meltranet.php';
	...
	$laLis = lisIni('facturaRec');	
	
	$lcPro = "CALL facturaRec(".idbVal(0).",".
		idbVal(0).",".
		idbVal(0).",".
		cdbVal('').",".
		cdbVal('').",".
...
<body>
    ...
    <div class="menuH">
		<ul class="menuH">
			<li class="menuH"><a class="menuH" href="crear" target="_self">crear una factura</a></li>
			<li class="menuH"><span class="separadorH">&#x2022;</span><li class="menuH"><a class="menuH" href="informe" target="_self">informes de facturas</a></li>
		</ul>
    </div>
...
<?php
	...
	$lcPro = "CALL facturaRec(".idbVal($laLis['iRec']).",".
	...
	while ($laMel = dbResFilCar($loReg)) {
		...
		<form method="post" action="ver/inicio.php">
        	<input type="hidden" name="idFactura" value="<?php iMostrar($laMel["idFactura"]);?>">
