<?php include '../../../../meltranet.php';
	...
	if (postExi('iAct')==true) {
		$lcPro = "CALL facturaServicioAct(".
			idbPost('iAct').",".
			idbPost('idFacturaServicio').",".
			cdbPost('cCantidad').",".
		...
		$lcPro = "CALL facturaServicioAct(0,".
			idbPost('idFacturaServicio').",".
			cdbPost('cCantidad').",".
			cdbPost('cDescripcion0').",".
			cdbPost('cDescripcion1').",".
...
<body>
    ...
    <div style="padding-top:6px; width:280px;">
		<form method="post">
    		...
    		<input name="idFacturaServicio" value="<?php iMostrar($laMel['idFacturaServicio']); ?>" type="hidden">
