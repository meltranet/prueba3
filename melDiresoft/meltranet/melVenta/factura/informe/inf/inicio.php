<?php include '../../../../meltranet.php';
	...
	$lcPro = "CALL facturainfRec(0,'',''".idbMel();
...
<body>
    <div class="menuN">
		<ul class="menuN">
            ...
            <li class="menuN"><a class="menuN" href="../" target="_parent">Informes de Facturas</a><span class="separadorN">/</span></li>
		</ul>
    </div>
	<h1>Listado de Facturas</h1>
	<form method="post" action="facturaRpt.php" target="_blank">
