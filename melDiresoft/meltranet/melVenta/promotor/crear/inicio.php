	    ...
	    <div style="width:280px; padding-top:3px;">
			<div style="border-bottom:1px solid #C6D4E0; padding:6px;">
				<div style="padding-bottom:3px;">
    	   			Introduzca un nombre para el nuevo promotor.
				</div>
			...
			<div style="padding:6px;"><button type="submit">Crear promotor</button></div>
		</div>
	</form>
</body>
</html>
