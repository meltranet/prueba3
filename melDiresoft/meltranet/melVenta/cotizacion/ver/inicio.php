...
<body>
    ...
    <div class="menuH">
		<ul class="menuH">
	        <li class="menuH"><a class="menuH" href="javascript:imprimir();">imprimir la cotizaci&oacute;n</a></li>
			<li class="menuH"><span class="separadorH">&#x2022;</span><a class="menuH" href="anular" target="_self">anular la cotizaci&oacute;n</a></li>
		</ul>
    </div>
...
<script language="JavaScript">
	function imprimir() {loRpt.imprimir("cotizacionRpt.php?id=0", 1);}
</script>
