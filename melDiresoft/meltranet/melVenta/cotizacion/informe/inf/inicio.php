<?php include '../../../../meltranet.php';
	...
	$lcPro = "CALL cotizacioninfRec(0,'',''".idbMel();
...
<body>
    <div class="menuN">
		<ul class="menuN">
			...
			<li class="menuN"><a class="menuN" href="../../../" target="ifmMeltranet">Ventas</a><span class="separadorN">/</span></li>
			<li class="menuN"><a class="menuN" href="../../" target="ifmMeltranet">Cotizaciones</a><span class="separadorN">/</span></li>
            <li class="menuN"><a class="menuN" href="../" target="_parent">Informes de Cotizaciones</a><span class="separadorN">/</span></li>
		</ul>
    </div>
	<h1>Listado de Cotizaciones</h1>
	<form method="post" action="cotizacionRpt.php" target="_blank">
