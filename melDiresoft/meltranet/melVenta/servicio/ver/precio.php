...
<body>
    <div class="menuN">
		<ul class="menuN">
			<li class="menuN"><a class="menuN" href="../../../../" target="_top">Inicio</a><span class="separadorN">/</span></li>
	...
	<h1>Cambiar el Precio de venta</h1>
    <div class="menuH">
		<ul class="menuH">
	...
	<form method="post">
	    ...
	    <div style="width:280px; padding-top:6px;">
			<div style="padding-top:6px; padding-left:6px;">
   			...
   			<div style="border-bottom:1px solid #C6D4E0; color:#777777; padding:6px;">
       		    <div style="padding:3px; border:1px solid #C6D4E0;">
		            <input name="cPrecio" style="width:260px; font-family:Arial; font-size:13px; margin:0px; padding:0px; border:none; background:none;"
			        	value="<?php cMostrar($laMel['cPrecio']); ?>" maxlength="13">
				</div>
	        </div>
			<div style="padding-top:6px; padding-left:6px;">
			...
			<div style="padding:6px;"><button type="submit">Cambiar precio de venta</button></div>
		</div>
	</form>
</body>
</html>
