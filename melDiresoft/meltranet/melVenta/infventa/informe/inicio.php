<?php include '../../../meltranet.php';
	...
	$lcPro = "CALL infventaRec(0,0".idbMel();
...
<body>
    <div class="menuN">
		<ul class="menuN">
			...
			<li class="menuN"><a class="menuN" href="../" target="ifmMeltranet">Informes de ventas</a><span class="separadorN">/</span></li>
		</ul>
    </div>
	<h1>Libro de ventas</h1>
	<form method="post" action="infventaRpt.php" target="_blank">
